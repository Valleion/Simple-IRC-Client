...
namespace IrcClient
{
    class ircClient
    {
        ...
        {
            sendIrcMessage(":" + userName + "!" + userName + "@" + userName + ".orwell.freenode.net PRIVMSG #" + channel + " :" + message);
        }
        public void kickUser(string user, string channel, string reason)
        {
            sendIrcMessage(":" + userName + "!" + userName + "@" + userName + ".orwell.freenode.net KICK #" + channel + " " + user + " :" + reason);
        }
